...
\copy (select * from care_site where care_site_id in ((select care_site_id from visit_occurrence where person_id = 107680)) order by care_site_id) TO 'care_site.csv'  WITH CSV HEADER;
