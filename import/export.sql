...
\copy (SELECT * FROM concept_class WHERE concept_class_id in ('Vocabulary','Concept Class','Domain','Clinical Finding','Relationship','Model Comp') ORDER BY concept_class_id) TO 'concept_class.csv' WITH CSV HEADER
