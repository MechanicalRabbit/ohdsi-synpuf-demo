...
( 
  ...
  select concept_id from CONCEPT where concept_id in (1335471,1340128,1341927,1363749,1308216,1310756,1373225,1331235,1334456,1342439)and invalid_reason is null
...
DELETE FROM cohort where cohort_definition_id = 1770675;

INSERT INTO cohort (cohort_definition_id, subject_id, cohort_start_date, cohort_end_date)

select 1770675 as cohort_definition_id, person_id, start_date, end_date 
